...
$this->_errors[] = 'Password should include uppercase and lowercase
characters.';
}
}
...
$this->_errors[] = "Password should include at least 
$this->_minimumNumbers number(s).";
}
}
...
$this->_errors[] = "Password should include at least 
$this->_minimumSymbols nonalphanumeric character(s).";
}
