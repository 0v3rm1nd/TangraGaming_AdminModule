...
// prepare SQL query
    $sql = 'SELECT email, nickname, name, signature, hobby, disabled FROM user WHERE email = ?';
    if ($stmt->prepare($sql)) {
// bind the query parameter
        $stmt->bind_param('s', $_GET['email']);
// bind the results to variables
        $stmt->bind_result($email, $nickname, $name, $signature, $hobby, $disabled);
                        ...
                        <div id="wrapper">
                            ...
                            <div id="login" class="animate form">
                                ...
                                <form id="form1" method="post" action="">
                                    ...
                                    <p id="email">
                                        Email can not be changed:<?php echo htmlentities($email, ENT_COMPAT, 'utf-8'); ?>
                                    </p>
